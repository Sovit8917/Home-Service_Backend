...
export class SupportService {
  ...
  async getFaqs() {
    const faqs = [
      { question: 'How do I book a service?', answer: 'Browse services, select a worker, choose date/time and confirm booking.' },
      { question: 'How do I cancel a booking?', answer: 'Go to your booking details and tap Cancel. Cancellation charges may apply.' },
      { question: 'When will I get my refund?', answer: 'Refunds are processed within 5-7 business days to your original payment method.' },
      { question: 'How is the worker rated?', answer: 'After service completion, you can rate and review the worker out of 5 stars.' },
      { question: 'Is my payment secure?', answer: 'Yes, all payments are processed via Razorpay with bank-grade encryption.' },
    ];
    return { data: faqs };
  }
}
